package com.banred.ms_middleware_signcrypt.encript.exceptions;

import com.banred.ms_middleware_signcrypt.encript.payloads.BodyErrorAes256;
import com.banred.ms_middleware_signcrypt.encript.payloads.IBodyError;
...
public class AbstractError extends AbstractException {
    ...
    public IBodyError getErrorAes256() {
        return this.errorAes256;
    }
